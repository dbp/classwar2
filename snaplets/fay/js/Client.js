...
var FFI = {};
var Client = {};
Client.mylog = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],console.log(Fay$$fayToJs_string($p1))));
  });
};
Client.setTimeout = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay_double(setTimeout(Fay$$fayToJs(["action",[["unknown"]]],$p2), Fay$$fayToJs_double($p1))));
    });
  };
};
Client.setInterval = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay_double(setInterval(Fay$$fayToJs(["action",[["unknown"]]],$p2), Fay$$fayToJs_double($p1))));
    });
  };
};
Client.main = new Fay$$$(function(){
  return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Client.setInterval)(1000))(Fay$$_(Client.mylog)(Fay$$list("WORLD!")))))(Fay$$_(Fay$$$_return)(Fay$$unit));
});
